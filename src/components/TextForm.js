...
//   text = "shsidi";//Not allowed
  ...
  return (
    ...
    <div className=" container my-3" style={{color: props.mode==="light"?"black":"white"}}>
      ...
      <button className="btn btn-primary my-2 mx-1" onClick={handleLowClick}>Change to lowercase</button>
      ...
      <button className="btn btn-primary my-2 mx-1" onClick={handleExtraClick}>Remove extra spaces</button>
